...
export const GET: APIRoute = async () => {
  ...
  const staticPages: SearchEntry[] = [
    ...
    { type: 'page', id: 'page:about-apply-submit', href: '/about/apply/submit', title: 'Submit a system proposal (interactive form)', description: 'Validated interactive form that generates ready-to-paste Markdown with a SHA-256 integrity checksum for the Registration Authority to verify.' },
    { type: 'page', id: 'page:about-apply-submit-authority', href: '/about/apply/submit-authority', title: 'Submit an authority proposal (interactive form)', description: 'Validated interactive form for proposing a new conversion system authority. Requires two authorised persons per Annex A.4.' },
