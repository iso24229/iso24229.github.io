...
date: 2026-07-06
summary: 'The register repo now ships one JSON Schema per item class, validates every YAML entry on push and PR, and accepts submissions via structured GitHub issue templates.'
author: 'CalConnect (ISO 24229/RA)'
tags: ['announcement', 'register-data', 'schemas', 'validation']
---

The [register](https://github.com/iso24229/register)
...
- **Two structured GitHub issue templates**:
  - [`register-new-system.yml`](https://github.com/iso24229/register/blob/main/.github/ISSUE_TEMPLATE/register-new-system.yml)
    for existing authorities adding a new system.
  - [`apply-new-authority.yml`](https://github.com/iso24229/register/blob/main/.github/ISSUE_TEMPLATE/apply-new-authority.yml)
